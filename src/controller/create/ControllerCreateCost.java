...
public class ControllerCreateCost implements Initializable {
    ...
    public boolean createCost(){
        try {
            ...
            SimpleStringProperty name, purchaseDate, comment, printerName;
            ...
            printerName = new SimpleStringProperty(comboBoxPrinter.getValue().getName());
            ...
            newCost = new Cost(id, quantity, printerId, name, purchaseDate, comment, shipping, price, printerName);
            return true;
